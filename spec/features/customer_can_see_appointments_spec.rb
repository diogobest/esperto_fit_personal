...
feature 'Customer can see apppointments' do
  ...
  scenario 'Successfully' do
    ...
    expect(page).to have_css('h1', text: "Agenda de #{profile.first_name} para 10/09/2019")
  ...
  scenario 'and can\'t access other units through direct link' do
    ...
    personal_account = create(:personal, email: 'teste@email.com', password: '123456', document:'12345678908')
